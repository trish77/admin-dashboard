 ...
 *   https://datatables.net/download/#dt/dt-1.10.22/b-1.6.4/b-print-1.6.4/fh-3.1.7/r-2.2.6
 *
 * Included libraries:
 *   DataTables 1.10.22, Buttons 1.6.4, Print view 1.6.4, FixedHeader 3.1.7, Responsive 2.2.6
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.22/b-1.6.4/b-print-1.6.4/fh-3.1.7/r-2.2.6",
