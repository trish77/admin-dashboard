    ...
    $.fn.hovercard = function (options) {
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    ...
                                    '.hc-details { left:240px; text-align:left; height: 190px; line-height:1.5em; border:solid 1px #ddd; position:absolute;-moz-border-radius:3px;font-size:12px;-webkit-border-radius:3px;border-radius:3px;top:-115px;padding:2em 10px 10px;-moz-box-shadow:5px 5px 5px #888;-webkit-box-shadow:5px 5px 5px #888;box-shadow:5px 5px 5px #888;display:none;}' +
