...
'</filter>',
    ...
    // button2: '<rect rx="5" ry="5" x="178" y="123" width="100" height="35" class="myteambtn"></rect><text class="myteambtn-text" text-anchor="middle" width="100" x="229" y="147">My Team</text>',
    noimage: '[noimage]',
    reporters: '[reporters]',
...
var data = [
    ...
    { id: 1, parentId: null, name: "Darcy Crane", title: "Clinical Nurse Supervisorsadfsdfdsa", tasks: "17", pastdue: "3", image: "https://s3.amazonaws.com/uifaces/faces/twitter/allisongrayce/128.jpg", button: "View", button2: "My Team" },
    ...
    { id: 4, parentId: 1, name: "Nicholas Frazier", title: "Quality Coordinator (RN)", tasks: "0", compliance: 2, image: "/content/images/prototype-actors/72.jpg", button: "View", button2: "My Team" },
...
$(document).ready(function(e) {
   ...
   $(".myteambtn").bind("click", function(event){ViewMyTeam();});
   $(".myteambtn-text").bind("click", function(event){ViewMyTeam();});

   function ViewProfile() {
    location.href = "dashboard-profile-quickview.php";
   }
   function ViewMyTeam() {
    opener.location.href = "dashboard-manager-dev-ready.php?proxy";
    window.close();
   }
    ...
    for (var i = 0; i < args.content.length; i++) {
        ...
        if (args.node.children.length != 0) {
            ...
            args.content[i] = args.content[i].replace("[reporters]", '<rect rx="5" ry="5" x="0" y="170" width="380" height="45" class="reportsbox get-btn"></rect>' +
                                                      '<text class="reportsbox-text" text-anchor="middle" width="380" x="190" y="194">' + args.node.children.length + ' Direct Reports</text><rect rx="5" ry="5" x="178" y="123" width="100" height="35" class="myteambtn"></rect><text class="myteambtn-text" text-anchor="middle" width="100" x="229" y="147">My Team</text>');
        } else {
